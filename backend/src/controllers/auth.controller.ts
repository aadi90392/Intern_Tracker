...
// role field intentionally yahan hai hi nahi — client kabhi role choose nahi kar sakta
...
export const signup = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const user = await User.create({ name, email, password: hashedPassword, role: 'intern' });
